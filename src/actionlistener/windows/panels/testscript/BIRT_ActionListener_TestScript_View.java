...
public class BIRT_ActionListener_TestScript_View implements BIRT_ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (null != e)
		{
			...
			if (e.getActionCommand().equals(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTSCRIPT_VIEW_CANCEL))
			{
