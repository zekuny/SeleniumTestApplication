...
public class BIRT_ActionListener_TestCase_View implements BIRT_ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		if (null != e)
		{
			...
			if (e.getActionCommand().equals(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTCASE_VIEW_CANCEL))
			{
