...
public class BIRT_Panel_TestScript_View extends BIRT_Panel
{
	...
	{
		jbCancel.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_TestScript_View());
	...
	protected void setLayout()
	{
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jsSeparator).addGroup(
				...
				layout.createSequentialGroup().addContainerGap(23, Short.MAX_VALUE).addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(jspTestSteps).addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								layout.createSequentialGroup().addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jlTestScriptName).addComponent(jlTestScriptDescription)).addGap(69, 69, 69)
										.addGroup(
												layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(jspTestScriptDescription).addComponent(jtTestScriptName,
														javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE))).addGroup(
								layout.createSequentialGroup().addGap(194, 194, 194).addComponent(jbCancel))).addGap(36, 36, 36)).addGroup(
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addComponent(jlHeader).addGap(18, 18, 18).addComponent(jsSeparator, javax.swing.GroupLayout.PREFERRED_SIZE, 10,
						...
						javax.swing.GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addComponent(jbCancel).addGap(24, 24, 24)));

	}

	protected void setPanelComponentActionCommands()
	{
		jbCancel.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTSCRIPT_VIEW_CANCEL);

	}

	protected void setPanelComponentText()
	{
		jlHeader.setText("View Test Script");
