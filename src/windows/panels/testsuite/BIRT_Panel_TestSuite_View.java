...
public class BIRT_Panel_TestSuite_View extends BIRT_Panel {
	...
	protected void addPanelComponentActionListeners() {
		jbCancel.addActionListener(BIRT_ActionListeners
				.getObjActionListener_Panel_TestSuite_View());
	...
	protected void setPanelComponentActionCommands() {
		jbCancel.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTSUITE_VIEW_CANCEL);

	}

	protected void setPanelComponentText() {
		jlHeader.setText("View Test Suite");
