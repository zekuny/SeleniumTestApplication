...
public class BIRT_Panel_TestSuite_Run extends BIRT_Panel
{
	...
	{
		jbRun.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_TestSuite_Run());
		jbCancel.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_TestSuite_Run());
	}
	...
	protected void initPanelComponents()
	{
		...
		jtTestFilePath.setEditable(false);
	...
	protected void setLayout()
	{
														...
														layout.createSequentialGroup()
																...
																.addGroup(
																		layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
																				...
																				.addGroup(
																						layout.createSequentialGroup()
																								.addComponent(jlTestFilePath)
																								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																								.addComponent(jtTestFilePath, javax.swing.GroupLayout.PREFERRED_SIZE, 228,
																										javax.swing.GroupLayout.PREFERRED_SIZE))																										
																				))
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup()
						...
						.addGap(31, 31, 31)
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jlTestFilePath)
										.addComponent(jtTestFilePath, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(31, 31, 31)
						.addGroup(
						...
						.addGap(18, 18, 18)
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jbRun)
	...
	{
		jbRun.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTSUITE_RUN_RUN);
		jbCancel.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTSUITE_RUN_CANCEL);

	}

	protected void setPanelComponentText()
	{
		jlHeader.setText("Run Test Suite");
	...
	{
		jtTestSuiteName.setText(BIRT_DataObject.getApp_Panel_TestSuite_BrowseRunNViewHstry_SelectedTestSuiteName());
		jtaTestSuiteDescription.setText(BIRT_DataObject.getApp_Panel_TestSuite_BrowseRunNViewHstry_SelectedTestSuiteDesc());
		jtTestFilePath.setText(BIRT_DataObject.getApp_Panel_TestSuite_BrowseRunNViewHstry_SelectedTestFilePath());
		updateList();
	...
	private void updateList() throws BIRT_Exception
	{
		...
		String strTestCaseNames[] = BIRT_Persistence.getObjBIPersistence_TestCase().getTestCaseNames(
				BIRT_DataObject.getIProjectID(),
				BIRT_Persistence.getObjBIPersistence_TestSuite().getTestSuiteTestCases(BIRT_DataObject.getApp_Panel_TestSuite_BrowseRunNViewHstry_SelectedTestSuiteID(),
						BIRT_DataObject.getIProjectID()));
