...
public class BIRT_Panel_TestCase_Copy extends BIRT_Panel
{
	...
	private javax.swing.JLabel				jlNewTestCaseName;
	...
	private javax.swing.JTextField			jtfNewTestCaseName;
	...
	{
		BIRT_ActionListener objActionListener = BIRT_ActionListeners.getObjActionListener_Panel_TestCase_Copy();
		jbCopy.addActionListener(objActionListener);
	...
	protected void initPanelComponents()
	{
		...
		jlNewTestCaseName = new javax.swing.JLabel();
		jtfNewTestCaseName = new javax.swing.JTextField();
	...
	{
		jtfNewTestCaseName.setText(BIRT_DataObject.NULL);
														...
														layout.createSequentialGroup()
																.addGroup(
																		layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
																				.addGroup(
																						layout.createSequentialGroup()
																								.addComponent(jlNewTestCaseName, javax.swing.GroupLayout.PREFERRED_SIZE, 170,
																										javax.swing.GroupLayout.PREFERRED_SIZE)
																								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																								.addComponent(jtfNewTestCaseName, javax.swing.GroupLayout.PREFERRED_SIZE, 219,
																										javax.swing.GroupLayout.PREFERRED_SIZE))
																				.addGroup(
																						layout.createSequentialGroup()
																								.addComponent(jlTestCaseName, javax.swing.GroupLayout.PREFERRED_SIZE, 170,
																										javax.swing.GroupLayout.PREFERRED_SIZE)
																								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																								.addComponent(jtfTestCaseName, javax.swing.GroupLayout.PREFERRED_SIZE, 219,
																										javax.swing.GroupLayout.PREFERRED_SIZE))
																				.addGroup(
																								...
																								.addGroup(
																										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
																												...
																												.addComponent(jlBaseURL, javax.swing.GroupLayout.DEFAULT_SIZE,
																														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																												.addComponent(jlTypeOfBrowser, javax.swing.GroupLayout.PREFERRED_SIZE, 170,
																														javax.swing.GroupLayout.PREFERRED_SIZE))
																								.addGap(57, 57, 57)
																								.addGroup(
																										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																												.addGroup(
																														layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
																																...
																																.addComponent(jtfScriptFile, javax.swing.GroupLayout.Alignment.TRAILING)
																																.addComponent(jtfBaseURL, javax.swing.GroupLayout.Alignment.TRAILING)
																																.addComponent(jspTestCaseDescription)
																																.addComponent(jcbTypeOfBrowser, javax.swing.GroupLayout.PREFERRED_SIZE,
																				...
																				.addGroup(
																						layout.createSequentialGroup()
																								.addComponent(jbCopy, javax.swing.GroupLayout.PREFERRED_SIZE, 85,
																										javax.swing.GroupLayout.PREFERRED_SIZE)
																								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jlNewTestCaseName, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jtfNewTestCaseName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						...
						.addGap(32, 32, 32).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jbCopy).addComponent(jbCancel)).addGap(22, 22, 22)));

	}

	protected void setPanelComponentActionCommands()
	{
		jbCopy.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTCASE_COPY_CREATE);
		jbCancel.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_TESTCASE_COPY_CANCEL);
	...
	{
		jlHeader.setText("Copy Test Case");

		jlTestCaseName.setText("Original Test Case Name");

		jlNewTestCaseName.setText("New Test Case Name");
	...
	{
		return jtfNewTestCaseName.getText().trim();
	}
