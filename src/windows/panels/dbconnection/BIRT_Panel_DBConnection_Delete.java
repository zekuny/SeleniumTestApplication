...
public class BIRT_Panel_DBConnection_Delete extends BIRT_Panel
{
...
//	private javax.swing.JTextField		jtDatabase;
	...
	{
		jbCancel.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_DBConnection_Delete());
		jbDelete.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_DBConnection_Delete());
	...
	//	jtDBPort.setEditable(false);
		jtDBConnectionString.setEditable(false);
								...
								layout.createSequentialGroup().addContainerGap().addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
												...
												//.addComponent(jlDBServer, javax.swing.GroupLayout.DEFAULT_SIZE,
													...
													//	javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(jlDBConnectionString, javax.swing.GroupLayout.DEFAULT_SIZE,
													javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												
												)
														.addGroup(
												layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(jlServiceName, javax.swing.GroupLayout.Alignment.LEADING,
										...
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(jtServiceName).addComponent(jpfPassword,
												javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
											//	.addComponent(jtDBPort)
											//	.addComponent(jtDatabase, javax.swing.GroupLayout.DEFAULT_SIZE, 242,
											//	Short.MAX_VALUE)
											//	.addComponent(jtDBServer, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
												...
												javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
												.addComponent(jtUserName,
												javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE).addGroup(
												javax.swing.GroupLayout.Alignment.TRAILING,
												layout.createSequentialGroup().addComponent(jbDelete).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jbCancel))))).addContainerGap(32, Short.MAX_VALUE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addComponent(jlHeader).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jsHeaderSeparator,
					...
					//			javax.swing.GroupLayout.PREFERRED_SIZE)
						...
						.addComponent(jtDBConnectionString, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
							javax.swing.GroupLayout.PREFERRED_SIZE)
						...
						//.addComponent(jlDatabase)
						//.addComponent(jtDatabase, javax.swing.GroupLayout.PREFERRED_SIZE,
						//		javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(18, 18, 18).addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jlServiceName).addComponent(jtServiceName, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(18, 18, 18).addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jbCancel).addComponent(jbDelete)).addContainerGap(20, Short.MAX_VALUE)));

	}

	protected void setPanelComponentActionCommands()
	{
		jbCancel.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_DBCONNECTION_DELETE_CANCEL);
		jbDelete.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_DBCONNECTION_DELETE_DELETE);

	}

	protected void setPanelComponentText()
	{
		jlHeader.setText("Delete DB Connection");
