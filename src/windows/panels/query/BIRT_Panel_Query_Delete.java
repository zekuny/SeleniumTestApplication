...
public class BIRT_Panel_Query_Delete extends BIRT_Panel
{
	...
	{
		jlHeader.setText(objResourceBundle.getString(BIRT_Resource_PropertyNames.TXT_APP_WINDOWS_PANELS_QUERY_DELETEQUERY));
	...
	{
		jbDelete.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_QUERY_DELETE_DELETE);
		jbCancel.setActionCommand(BIRT_ActionListener.APP_WINDOWS_PANELS_QUERY_DELETE_CANCEL);
	}

	protected void addPanelComponentActionListeners()
	{
		jbDelete.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_Query_Delete());
		jbCancel.addActionListener(BIRT_ActionListeners.getObjActionListener_Panel_Query_Delete());
								...
								layout.createSequentialGroup().addGap(26, 26, 26).addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addGroup(
												...
												layout.createSequentialGroup().addComponent(jlQuery).addGap(81, 81, 81).addGroup(
														layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jbDelete).addComponent(jspQuery,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addGap(13, 13, 13).addComponent(jlHeader).addGap(18, 18, 18).addComponent(jsHeaderSeparator, javax.swing.GroupLayout.PREFERRED_SIZE, 10,
						...
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jlQuery).addComponent(jspQuery, javax.swing.GroupLayout.PREFERRED_SIZE, 109,
								javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(18, 18, 18).addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jbDelete).addComponent(jbCancel)).addContainerGap()));
